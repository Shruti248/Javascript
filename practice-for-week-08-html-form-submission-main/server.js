...
const server = http.createServer((req, res) => {
  ...
  req.on("end", () => {
    ...
    if(req.method === 'POST' && req.url === '/cat'){
      ...
      cat = new Cat({name : req.body.name , pattern :req.body.pattern, size :req.body.size, description:req.body.description});
    ...
    if(req.method ==='POST' && req.url === '/dog'){
      dog = new Dog({name : req.body.name, color : req.body.color, age:req.body.age, description : req.body.description})
